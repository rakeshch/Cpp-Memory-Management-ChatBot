...
private:
    ...
    // Resource Acquisition Is Initialization (RAII) using smart pointers
    // std::make_unique() (>= C++14 ONLY), unique_ptr() (>= C++11)
...
public:
    ...
    // getter / setter - Use .get() function to retrieve a raw pointer to the object
